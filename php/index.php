    ...
    <header>
        <div class="header-container">
            <div id="header-balk" class="header-balk">
                <div class="logo">
                    <img src="../images/Screenshot 2022-03-11 111514.png" alt="Logo Restaurant" width="150"
                        height="50" />
                </div>
    ...
    <body>
      ...
      <form action="form.php" method="POST">
        ...
        <input type="submit" name="submitknop" value="Verstuur">
      </form>
    </div> -->
        <main>
            <div class="container-index">
                <div class="blok-index1">
                    <div class="container-tekst-index">
                        <div>
