...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 21 apr 2022 om 12:52
...
--
-- Fout bij lezen van tabelstructuur van tabel contact.contact: #1932 - Table &#039;contact.contact&#039; doesn&#039;t exist in engine
-- Fout bij het lezen van gegevens voor tabel contact.contact: #1064 - Er is iets fout in de gebruikte syntax bij &#039;FROM `contact`.`contact`&#039; in regel 1
--
-- Database: `orders`
--
...
--
-- Fout bij lezen van tabelstructuur van tabel orders.orders: #1932 - Table &#039;orders.orders&#039; doesn&#039;t exist in engine
-- Fout bij het lezen van gegevens voor tabel orders.orders: #1064 - Er is iets fout in de gebruikte syntax bij &#039;FROM `orders`.`orders`&#039; in regel 1
--
-- Database: `phplogin`
--
...
('root', '[{\"db\":\"productdb\",\"table\":\"producttb\"},{\"db\":\"phplogin\",\"table\":\"accounts\"},{\"db\":\"reservation\",\"table\":\"reservations\"},{\"db\":\"contact\",\"table\":\"contact\"}]');
...
('root', '2022-04-12 10:42:12', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"nl\"}');
...
--
-- Tabelstructuur voor tabel `producttb`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `producttb`
--

INSERT INTO `producttb` (`id`, `product_name`, `product_price`, `product_image`) VALUES
(1, 'Steak frites', 22, '	../Shopping/upload/product1.png'),
(2, 'Crème brûlée', 12, '../Shopping/upload/product2.png'),
(3, 'Escargot', 18, '../Shopping/upload/product3.png'),
(4, 'Steak tartare', 20, '../Shopping/upload/product4.png'),
(5, 'Kimchi', 3, '../Shopping/upload/product10.jpg'),
(6, 'Kaas Balletjes', 7, '../Shopping/upload/product11.jpg'),
(7, 'Cacao Pudding', 16, '../Shopping/upload/product6.jpg'),
(8, 'Brownies', 20, '../Shopping/upload/product7.jpg'),
(9, 'Zalm Filet', 40, '../Shopping/upload/product8.jpg'),
(10, 'Frites', 5, '	../Shopping/upload/product9.jpg');
...
--
-- AUTO_INCREMENT voor een tabel `producttb`
--
ALTER TABLE `producttb`
...
--
-- Fout bij lezen van tabelstructuur van tabel reservation.reservations: #1932 - Table &#039;reservation.reservations&#039; doesn&#039;t exist in engine
-- Fout bij het lezen van gegevens voor tabel reservation.reservations: #1064 - Er is iets fout in de gebruikte syntax bij &#039;FROM `reservation`.`reservations`&#039; in regel 1
--
-- Database: `test`
--
...
(18, 'Arnhem', 'NLD', 'Gelderland', 163964),
...
--
ALTER TABLE `city`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4082;
COMMIT;
